...
const AdminTeachers = () => {
  ...
  const handleEditClick = (teacher) => {
    ...
    setFormData({
      ...
      email: teacher.email,
      phone: teacher.phone,
      photo: null, // Rasm qayta yuklanishi uchun null qilinadi
    });
    setShowForm(true);
      ...
      <AnimatePresence>
        {showForm && (
          ...
          >
            ...
            <button
              disabled={btnLoading}
              className="md:col-span-2 bg-[#0a1128] text-white py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] italic shadow-2xl active:scale-[0.98] transition-all flex justify-center items-center gap-3 disabled:opacity-50 mt-4"
            >
              {btnLoading ? (
